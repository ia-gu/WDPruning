...
def get_args_parser():
    ...
    parser.add_argument('--model-path', type=str, default='/home/ueno/pruning/width-and-Depth-pruning-for-Vision-Transformer/checkpoint/deit_small_patch16_224-cd65a155.pth')
...
def main(args):
    ...
    if 'deit_small' in args.model_path:
        embed_dim = 384
        num_heads = 6
    elif 'deit_tiny' in args.model_path:
        embed_dim = 192
        num_heads = 3
